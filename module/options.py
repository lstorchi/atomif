...
class optiondialog_files(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.firstmol2file_line = QtWidgets.QLineEdit("./e200k.mol2", self)
        ...
        self.firstweigfile_line = QtWidgets.QLineEdit("./lista_e200k.txt", self)
        ...
        self.secondmol2file_line = QtWidgets.QLineEdit("./wt.mol2", self)
        ...
        self.secondweigfile_line = QtWidgets.QLineEdit("./lista_wt.txt", self)
